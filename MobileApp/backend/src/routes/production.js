...
async function productionRoutes(fastify, options) {
  ...
  fastify.get('/analytics', { preHandler: [fastify.authenticate] }, async (request, reply) => {
    try {
      ...
      const productivityByUser = db.db
        .prepare(
          `
