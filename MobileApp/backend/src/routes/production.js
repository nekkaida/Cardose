...
async function productionRoutes(fastify, options) {
  ...
  fastify.post('/workflows', { preHandler: [fastify.authenticate] }, async (request, reply) => {
    try {
  ...
  fastify.put('/tasks/:id/assign', { preHandler: [fastify.authenticate] }, async (request, reply) => {
    try {
      const { id } = request.params;
  ...
  fastify.put('/tasks/:id/quality', { preHandler: [fastify.authenticate] }, async (request, reply) => {
    try {
      const { id } = request.params;
