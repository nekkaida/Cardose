...
const mockCustomerTranslations: Record<string, string> = {
  ...
  'customers.exportError': 'Failed to export customers',
  'customers.clearFilters': 'Clear Filters',
  'customers.filterByType': 'Filter by business type',
  'customers.filterByLoyalty': 'Filter by loyalty status',
  'customers.firstPage': 'First page',
  'customers.lastPage': 'Last page',
